...
public class DictionnaireTest2 {
	...
	public void testFiltreLettreFin() {
		...
		int[] filtered = { 5, 52, 346, 1406, 3991, 8274, 14045, 19199, 21460, 20105, 16106, 11334, 7050, 3879, 2003,
				930, 435, 189, 93, 39, 17, 5, 1, 0, 0 };
	...
	public void testFiltreLettreDebut() {
		...
		int[] expected = { 81, 427, 1807, 5916, 13945, 25577, 38343, 47671, 50254, 45851, 36343, 25313, 15462, 8530,
				4287, 2022, 894, 395, 181, 77, 32, 9, 2, 1, 0 };
		int[] filtered = { 9, 20, 131, 493, 1269, 2510, 3755, 4784, 5101, 4661, 3859, 2682, 1671, 945, 495, 264, 122,
				60, 29, 19, 11, 3, 2, 0, 0 };
